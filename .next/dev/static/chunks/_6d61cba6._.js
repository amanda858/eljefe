...
"[project]/components/sport-intel-feed.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function SportIntelFeed({ sport, initialItems }) {
    _s();
    ...
    const [isLoading, setIsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SportIntelFeed.useEffect": ()=>{
            const controller = new AbortController();
            setIsLoading(true);
            fetch(`/api/sports/${sport.toLowerCase()}/intel`, {
                signal: controller.signal
            }).then({
                "SportIntelFeed.useEffect": async (response)=>{
                    if (!response.ok) {
                        throw new Error("Failed to load sport intel");
                    }
                    return response.json();
                }
            }["SportIntelFeed.useEffect"]).then({
                "SportIntelFeed.useEffect": (data)=>{
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startTransition"])({
                        "SportIntelFeed.useEffect": ()=>{
                            setItems(data.items);
                        }
            ...
            }["SportIntelFeed.useEffect"]).catch({
                "SportIntelFeed.useEffect": (error)=>{
                    if (error instanceof Error && error.name === "AbortError") {
                        return;
                    }
                }
            }["SportIntelFeed.useEffect"]).finally({
                "SportIntelFeed.useEffect": ()=>{
                    if (!controller.signal.aborted) {
                        setIsLoading(false);
                    }
            ...
            return ({
                "SportIntelFeed.useEffect": ()=>controller.abort()
            })["SportIntelFeed.useEffect"];
        }
    }["SportIntelFeed.useEffect"], [
        sport
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                fileName: "[project]/components/sport-intel-feed.tsx",
                                lineNumber: 51,
                                columnNumber: 21
                            }, this),
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        children: isLoading ? "Refreshing" : items.length ? "Live intel" : "No live intel"
                    }, void 0, false, {
                        fileName: "[project]/components/sport-intel-feed.tsx",
                        lineNumber: 54,
                        columnNumber: 17
            ...
            items.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: items.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("article", {
                        className: "news-card dark-news-card",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                        children: "There is no sport-specific note feed connected yet."
                    }, void 0, false, {
                        fileName: "[project]/components/sport-intel-feed.tsx",
                        lineNumber: 72,
                        columnNumber: 21
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "market-detail-copy",
                        children: "The page now stays honest instead of rendering editorial placeholder notes."
                    }, void 0, false, {
                        fileName: "[project]/components/sport-intel-feed.tsx",
                        lineNumber: 73,
                        columnNumber: 21
...
_s(SportIntelFeed, "0j+EG8/8+2pMnGxQj8ENtVXUK08=");
_c = SportIntelFeed;
var _c;
__turbopack_context__.k.register(_c, "SportIntelFeed");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_6d61cba6._.js.map